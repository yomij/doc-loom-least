...
Amend the active constitution with a constitutional principle: Human Experience
Comes First. The active constitution now lives at
`docs/authority/constitution.md`.
