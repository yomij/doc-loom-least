...
does not mean a CLI backend, daemon, centralized orchestration service, app
backend, or complex pipeline product.

## Constitutional Principles

- Enter through the minimum path.
- Do not become a complex pipeline product.
- Keep human-facing documents and workflows semantic, readable, and beautiful.
- Put human experience first; agents should own discoverable work when no real
