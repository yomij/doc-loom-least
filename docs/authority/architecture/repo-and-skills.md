...
or risk types: direct work has no case; compact persistent work uses concise
plan/closure artifacts; guarded work adds current-plan confirmation, exact-
baseline deep review, and durable evidence. Artifact, review, and commit costs
are generated by their triggers rather than imposed by persistence itself.
